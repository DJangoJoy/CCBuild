...
public:
    ...
    void setupUi(QDialog *DisplayOptionsDlg)
    {
        ...
        DisplayOptionsDlg->resize(500, 470);
        ...
        pageOtherOptions->setGeometry(QRect(0, 0, 482, 313));
        ...
        autoDisplayNormalsCheckBox->setObjectName(QStringLiteral("autoDisplayNormalsCheckBox"));

        verticalLayout_8->addWidget(autoDisplayNormalsCheckBox);

        useNativeDialogsCheckBox = new QCheckBox(pageOtherOptions);
        useNativeDialogsCheckBox->setObjectName(QStringLiteral("useNativeDialogsCheckBox"));
    ...
    void retranslateUi(QDialog *DisplayOptionsDlg)
    {
        ...
        autoDisplayNormalsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Automatically display normals at loading time (when available)", Q_NULLPTR));
        useNativeDialogsCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Use native load / save dialogs", Q_NULLPTR));
