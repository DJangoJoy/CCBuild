...
public:
    ...
    void retranslateUi(QDialog *PlaneEditDlg)
    {
        ...
        orientationTabWidget->setTabText(orientationTabWidget->indexOf(dipTab), QApplication::translate("PlaneEditDlg", "Dip / dip direction", Q_NULLPTR));
        nxDoubleSpinBox->setPrefix(QApplication::translate("PlaneEditDlg", "Nx = ", Q_NULLPTR));
        nyDoubleSpinBox->setPrefix(QApplication::translate("PlaneEditDlg", "Ny = ", Q_NULLPTR));
        nzDoubleSpinBox->setPrefix(QApplication::translate("PlaneEditDlg", "Nz = ", Q_NULLPTR));
        orientationTabWidget->setTabText(orientationTabWidget->indexOf(normTab), QApplication::translate("PlaneEditDlg", "Normal", Q_NULLPTR));
        dimGroupBox->setTitle(QApplication::translate("PlaneEditDlg", "Dimensions", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        centerGroupBox->setTitle(QApplication::translate("PlaneEditDlg", "Center", Q_NULLPTR));
