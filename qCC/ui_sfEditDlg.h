...
public:
    ...
    void setupUi(QWidget *SFEditDlg)
    {
        ...
        minValSpinBox->setKeyboardTracking(false);
        ...
        maxValSpinBox->setKeyboardTracking(false);
        ...
        minSatSpinBox->setKeyboardTracking(false);
        ...
        maxSatSpinBox->setKeyboardTracking(false);
