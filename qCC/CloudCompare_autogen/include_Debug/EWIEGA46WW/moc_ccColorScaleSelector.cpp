...
void ccColorScaleSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ccColorScaleSelector::colorScaleSelected)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ccColorScaleSelector::colorScaleEditorSummoned)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ccColorScaleSelector::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ccColorScaleSelector.data,
      qt_meta_data_ccColorScaleSelector,  qt_static_metacall, nullptr, nullptr}
};
