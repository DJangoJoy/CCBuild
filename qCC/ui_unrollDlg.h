...
public:
    ...
    void retranslateUi(QDialog *UnrollDialog)
    {
        ...
        groupBox_2->setTitle(QApplication::translate("UnrollDialog", "Shape", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        labelAngle->setText(QApplication::translate("UnrollDialog", "Half angle", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        halfAngleDoubleSpinBox->setToolTip(QApplication::translate("UnrollDialog", "Cone angle (0-180\302\260)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        halfAngleDoubleSpinBox->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        halfAngleDoubleSpinBox->setSuffix(QApplication::translate("UnrollDialog", " deg", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        unrollRangeGroupBox->setToolTip(QApplication::translate("UnrollDialog", "Unroll range (can do multiple turns)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        unrollRangeGroupBox->setTitle(QApplication::translate("UnrollDialog", "Unroll range", Q_NULLPTR));
        label_2->setText(QApplication::translate("UnrollDialog", "Start angle", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        startAngleDoubleSpinBox->setToolTip(QApplication::translate("UnrollDialog", "Starting angle (can be negative)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        startAngleDoubleSpinBox->setSuffix(QApplication::translate("UnrollDialog", " deg", Q_NULLPTR));
        label_4->setText(QApplication::translate("UnrollDialog", "Stop angle", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        stopAngleDoubleSpinBox->setToolTip(QApplication::translate("UnrollDialog", "Stop angle (can be negative)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        stopAngleDoubleSpinBox->setSuffix(QApplication::translate("UnrollDialog", " deg", Q_NULLPTR));
    } // retranslateUi
