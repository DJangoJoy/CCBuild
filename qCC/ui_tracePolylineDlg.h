...
public:
    ...
    void setupUi(QDialog *TracePolyLineDlg)
    {
        ...
        TracePolyLineDlg->resize(433, 26);
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        continueToolButton->setToolTip(QApplication::translate("TracePolyLineDlg", "Continue the current polyline edition", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
        continueToolButton->setShortcut(QApplication::translate("TracePolyLineDlg", "C", Q_NULLPTR));
