...
public:
    ...
    void setupUi(QDialog *PrimitiveFactoryDlg)
    {
        ...
        spherePosXDoubleSpinBox->setObjectName(QStringLiteral("spherePosXDoubleSpinBox"));
        spherePosXDoubleSpinBox->setDecimals(6);
        spherePosXDoubleSpinBox->setMinimum(-1e+9);
        spherePosXDoubleSpinBox->setMaximum(1e+9);

        gridLayout_7->addWidget(spherePosXDoubleSpinBox, 1, 1, 1, 1);

        spherePosYDoubleSpinBox = new QDoubleSpinBox(groupBox);
        spherePosYDoubleSpinBox->setObjectName(QStringLiteral("spherePosYDoubleSpinBox"));
        spherePosYDoubleSpinBox->setDecimals(6);
        spherePosYDoubleSpinBox->setMinimum(-1e+9);
        spherePosYDoubleSpinBox->setMaximum(1e+9);

        gridLayout_7->addWidget(spherePosYDoubleSpinBox, 2, 1, 1, 1);

        spherePosZDoubleSpinBox = new QDoubleSpinBox(groupBox);
        spherePosZDoubleSpinBox->setObjectName(QStringLiteral("spherePosZDoubleSpinBox"));
        spherePosZDoubleSpinBox->setDecimals(6);
        spherePosZDoubleSpinBox->setMinimum(-1e+9);
        spherePosZDoubleSpinBox->setMaximum(1e+9);
        ...
        spherePosToOriginButton->setObjectName(QStringLiteral("spherePosToOriginButton"));

        horizontalLayout_3->addWidget(spherePosToOriginButton);

        spherePosFromClipboardButton = new QPushButton(groupBox);
        spherePosFromClipboardButton->setObjectName(QStringLiteral("spherePosFromClipboardButton"));
    ...
    void retranslateUi(QDialog *PrimitiveFactoryDlg)
    {
        ...
        groupBox->setTitle(QApplication::translate("PrimitiveFactoryDlg", "Position", Q_NULLPTR));
        label_21->setText(QApplication::translate("PrimitiveFactoryDlg", "y", Q_NULLPTR));
        label_22->setText(QApplication::translate("PrimitiveFactoryDlg", "z", Q_NULLPTR));
        label_20->setText(QApplication::translate("PrimitiveFactoryDlg", "x", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        spherePosToOriginButton->setToolTip(QApplication::translate("PrimitiveFactoryDlg", "Set position to origin", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        spherePosToOriginButton->setText(QApplication::translate("PrimitiveFactoryDlg", "clear", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        spherePosFromClipboardButton->setToolTip(QApplication::translate("PrimitiveFactoryDlg", "Try to interpret clipboard contents as position (\"x y z\")", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        spherePosFromClipboardButton->setText(QApplication::translate("PrimitiveFactoryDlg", "clipboard", Q_NULLPTR));
