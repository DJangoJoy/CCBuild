...
public:
    ...
    void setupUi(QDialog *SaveLASFileDialog)
    {
        ...
        extraFieldGroupBox = new QGroupBox(SaveLASFileDialog);
        ...
        verticalLayout->addWidget(extraFieldGroupBox);
...
"(especially if you have transformed the original data)", Q_NULLPTR));
        ...
        extraFieldGroupBox->setTitle(QApplication::translate("SaveLASFileDialog", "Save additional field(s)", Q_NULLPTR));
    } // retranslateUi
