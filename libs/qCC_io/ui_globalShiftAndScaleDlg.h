...
public:
    ...
    QCheckBox *preserveShiftOnSaveCheckBox;
    ...
    void setupUi(QDialog *GlobalShiftAndScaleDlg)
    {
        ...
        preserveShiftOnSaveCheckBox = new QCheckBox(frame);
        preserveShiftOnSaveCheckBox->setObjectName(QStringLiteral("preserveShiftOnSaveCheckBox"));
        preserveShiftOnSaveCheckBox->setChecked(true);

        horizontalLayout_2->addWidget(preserveShiftOnSaveCheckBox);
        ...
        QObject::connect(preserveShiftOnSaveCheckBox, SIGNAL(toggled(bool)), infoLabel, SLOT(setVisible(bool)));
...
"coordinate system", Q_NULLPTR));
        ...
        preserveShiftOnSaveCheckBox->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Preserve global shift on save", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
